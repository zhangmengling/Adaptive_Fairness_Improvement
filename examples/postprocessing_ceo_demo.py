...
def metric_test(dataset_name):
    ...
    for protected_attribute in protected_attributes:
        ...
        eqodds_metrics = metric_test_without_thresh(dataset=dataset_orig_test,
                                                    dataset_pred=dataset_transf_test_pred,
                                                    privileged_groups=privileged_groups,
                                                    unprivileged_groups=unprivileged_groups)
        print("-->validating on transformed testing data ")
        describe_metrics(eqodds_metrics, thresh_arr)
        ...
        # Plot.plot_acc_metric(lr_orig_metrics, lr_transf_metrics, "stat_par_diff")
        multi_metric_names = ["stat_par_diff", "avg_odds_diff", "eq_opp_diff"]
        Plot_class.plot_acc_multi_metric(orig_test_metrics, eqodds_metrics, multi_metric_names)


dataset_name = "Adult income"   # Adult income , German credit
