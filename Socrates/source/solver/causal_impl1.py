        ...
        if not self.plot:
            if self.object == "neuron":
                ...
                for do_layer in self.do_layer:
                    ...
                    neuron_idx = 0
                    for do_neuron in self.do_neuron[col]:
                        ie, min, max = self.get_ie_do_h_dy(do_layer, do_neuron, self.sens_idx, self.sens_value,
                                                           self.stepsize, 0)
                ...
                plt.savefig(self.resultpath + '/' + 'high_causal_effect' + ".png")
                ...
                # plt.legend()
                plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), ncol=3, fancybox=True)
                plt.savefig(self.resultpath + '/' + 'all_causal_effect' + ".png")
