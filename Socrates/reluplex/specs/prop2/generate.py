...
def get_nnet():
    nnet = ['reluplex/nnet/nnet_2_1', 'reluplex/nnet/nnet_2_2', 'reluplex/nnet/nnet_2_3', \
...
def get_prop():
    prop = ['prop2_nnet_2_1.json', 'prop2_nnet_2_2.json', 'prop2_nnet_2_3.json', \
        'prop2_nnet_2_4.json', 'prop2_nnet_2_5.json', 'prop2_nnet_2_6.json', \
        'prop2_nnet_2_7.json', 'prop2_nnet_2_8.json', 'prop2_nnet_2_9.json', \
        'prop2_nnet_3_1.json', 'prop2_nnet_3_2.json', 'prop2_nnet_3_3.json', \
        'prop2_nnet_3_4.json', 'prop2_nnet_3_5.json', 'prop2_nnet_3_6.json', \
        'prop2_nnet_3_7.json', 'prop2_nnet_3_8.json', 'prop2_nnet_3_9.json', \
        'prop2_nnet_4_1.json', 'prop2_nnet_4_2.json', 'prop2_nnet_4_3.json', \
        'prop2_nnet_4_4.json', 'prop2_nnet_4_5.json', 'prop2_nnet_4_6.json', \
        'prop2_nnet_4_7.json', 'prop2_nnet_4_8.json', 'prop2_nnet_4_9.json', \
        'prop2_nnet_5_1.json', 'prop2_nnet_5_2.json', 'prop2_nnet_5_3.json', \
        'prop2_nnet_5_4.json', 'prop2_nnet_5_5.json', 'prop2_nnet_5_6.json', \
        'prop2_nnet_5_7.json', 'prop2_nnet_5_8.json', 'prop2_nnet_5_9.json']
