def get_template():
  ...
  "model": {
    "shape": "(1,5)",
    "bounds": "[(-0.3035,-0.2986), (-0.0095,0.0095), (0.0,0.0), (0.3182,0.5), (0.0833,0.1667)]",
    "layers": [
      {
        "type": "linear",
...
def get_prop():
    prop = ['prop4_nnet_1_1.json', 'prop4_nnet_1_2.json', 'prop4_nnet_1_3.json', \
        'prop4_nnet_1_4.json', 'prop4_nnet_1_5.json', 'prop4_nnet_1_6.json', \
        'prop4_nnet_2_1.json', 'prop4_nnet_2_2.json', 'prop4_nnet_2_3.json', \
        'prop4_nnet_2_4.json', 'prop4_nnet_2_5.json', 'prop4_nnet_2_6.json', \
        'prop4_nnet_2_7.json', 'prop4_nnet_2_8.json', 'prop4_nnet_2_9.json', \
        'prop4_nnet_3_1.json', 'prop4_nnet_3_2.json', 'prop4_nnet_3_3.json', \
        'prop4_nnet_3_4.json', 'prop4_nnet_3_5.json', 'prop4_nnet_3_6.json', \
        'prop4_nnet_3_7.json', 'prop4_nnet_3_8.json', 'prop4_nnet_3_9.json', \
        'prop4_nnet_4_1.json', 'prop4_nnet_4_2.json', 'prop4_nnet_4_3.json', \
        'prop4_nnet_4_4.json', 'prop4_nnet_4_5.json', 'prop4_nnet_4_6.json', \
        'prop4_nnet_4_7.json', 'prop4_nnet_4_8.json', 'prop4_nnet_4_9.json', \
        'prop4_nnet_5_1.json', 'prop4_nnet_5_2.json', 'prop4_nnet_5_3.json', \
        'prop4_nnet_5_4.json', 'prop4_nnet_5_5.json', 'prop4_nnet_5_6.json', \
        'prop4_nnet_5_7.json', 'prop4_nnet_5_8.json', 'prop4_nnet_5_9.json']
